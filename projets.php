<div id="containerProjet" style="font-family:Montserrat;">
		...
		<div id="projetsliste">
			...
			<div class="projets" id="rpg">
				<p class="pDroit">Dans le cadre de mes études, j'ai dû réaliser un projet en groupe de 3 sur la création d'un jeux RPG nomé Ring en Java.</br></br>
				...
				nous avons eu le temps de faire quelques fenêtres graphiques qui rendait la manière de jouer largement plus agraiable, pour rentrer les différentes statistiques du personnage par exemple.
			...
			<div class="projets" id="blueNote">
				<p class="pGauche" >
				Toujours dans le cadre de mes études, j'ai aussi dû réaliser un site web sur un restaurant nomé Bleu Note.
				</br></br> Le but était de créer un nouveau site sur le thème du Jazz car le restaurant était un restaurant/bar musical.
				</br> Il fallait créer différentes rebriques, une notament sur les différents artistes avec leurs passages dans le restaurants, les artistes souvant présents,
				mais aussi une rebrique qui permetait de présenter la carte du restaurant, avec aussi une liste des vins que le restaurant vend.
				</p>
				<img src="./images/BlueNote1.png" alt="Photo site du restaurant Blue Note" style="width:750px;height:450px; float:right; margin-right:30px; margin-top:20px; box-shadow:3px 3px 3px 3px #888888" />
			</div>
